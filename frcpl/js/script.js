...
function w3CodeColorize(x, lang) {
    var tagcolor = "#FF6A00";
    var tagnamecolor = "lime";
    var attributecolor = "red";
    var attributevaluecolor = "#FF6A00";
    var commentcolor = "gray";
    var cssselectorcolor = "lime";
    var csspropertycolor = "red";
    var csspropertyvaluecolor = "#FF6A00";
    var cssdelimitercolor = "white";
    var cssimportantcolor = "red";
    var jscolor = "white";
    var jskeywordcolor = "#FF6A00";
    var jsstringcolor = "lime";
    var jsnumbercolor = "red";
    var jspropertycolor = "white";
    var javacolor = "white";
    var javakeywordcolor = "#FF6A00";
    var javastringcolor = "lime";
    var javanumbercolor = "red";
    var javapropertycolor = "white";
    var kotlincolor = "white";
    var kotlinkeywordcolor = "#FF6A00";
    var kotlinstringcolor = "lime";
    var kotlinnumbercolor = "red";
    var kotlinpropertycolor = "white";
    var phptagcolor = "red";
    var phpcolor = "white";
    var phpkeywordcolor = "#FF6A00";
    var phpglobalcolor = "goldenrod";
    var phpstringcolor = "lime";
    var phpnumbercolor = "red";
    var pythoncolor = "white";
    var pythonkeywordcolor = "#FF6A00";
    var pythonstringcolor = "lime";
    var pythonnumbercolor = "red";
    var angularstatementcolor = "red";
    var sqlcolor = "white";
    var sqlkeywordcolor = "#FF6A00";
    var sqlstringcolor = "lime";
    var sqlnumbercolor = "";
    if (!lang) { lang = "html"; }
